...
// https://github.com/BurntSushi/ripgrep/blob/418d048b2701b817d910161bdd040caf0d3f8f32/crates/ignore/src/default_types.rs
...
var defaultTypes = map[string][]string{
	...
	"asm":          {"*.asm", "*.s", "*.S"},
	"asp":          {"*.aspx", "*.aspx.cs", "*.aspx.vb", "*.ascx", "*.ascx.cs", "*.ascx.vb"},
	...
	"lzma":       {"*.lzma"},
	"m4":         {"*.ac", "*.m4"},
	"make":       {"[Gg][Nn][Uu]makefile", "[Mm]akefile", "[Gg][Nn][Uu]makefile.am", "[Mm]akefile.am", "[Gg][Nn][Uu]makefile.in", "[Mm]akefile.in", "*.mk", "*.mak"},
	"mako":       {"*.mako", "*.mao"},
	...
	"robot":      {"*.robot"},
	"rst":        {"*.rst"},
	"ruby":       {"config.ru", "Gemfile", ".irbrc", "Rakefile", "*.gemspec", "*.rb", "*.rbw"},
	"rust":       {"*.rs"},
	"sass":       {"*.sass", "*.scss"},
	"scala":      {"*.scala", "*.sbt"},
